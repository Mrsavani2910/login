...
import 'package:mahadev_s_application19/domain/facebookauth/facebook_auth_helper.dart';
import 'package:mahadev_s_application19/domain/googleauth/google_auth_helper.dart';
                                                                  ...
                                                                  children: [
                                                                    Align(
                                                                        ...
                                                                        child: GestureDetector(
                                                                            ...
                                                                            child: Padding(padding: getPadding(left: 40, top: 16, right: 40, bottom: 16), child: CommonImageView(svgPath: ImageConstant.imgFacebook, height: getVerticalSize(24.00), width: getHorizontalSize(12.00)))))
                                                                  ]))),
                                                      Container(
                                                          height:
                                                              getVerticalSize(
